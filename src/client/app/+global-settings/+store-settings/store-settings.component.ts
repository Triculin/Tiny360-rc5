...
from '../../shared/index';
/**
 * This class represents the lazy loaded StoreSettingsComponent.
 */
@Component({
  moduleId: module.id,
...
export class StoreSettingsComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.itemsObservables.subscribe((res: any) => {
      this.tabs = res.globalsettings.storesettingData;
      this.data = res.globalsettings.storesettingData[0].values;
      this.showNumberOfItemsList=res.globalsettings.storesettingData[0].showRowsList;
      this.sortedCols = res.globalsettings.storesettingData[0].sorted;
      this.numberOfItems = res.globalsettings.storesettingData[0].values.length;
