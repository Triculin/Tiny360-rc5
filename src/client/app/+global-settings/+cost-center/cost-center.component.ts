...
/**
 * This class represents the lazy loaded CostCenterComponent.
 */
@Component({
  moduleId: module.id,
  selector: 'ap-cost-center',
...
export class CostCenterComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.itemsObservables.subscribe((res: any) => {
      this.tabs = res.globalsettings.costcenterData;
      this.data = res.globalsettings.costcenterData[0].values;
      this.showNumberOfItemsList=res.globalsettings.costcenterData[0].showRowsList;
      this.sortedCols = res.globalsettings.costcenterData[0].sorted;
      this.numberOfItems = res.globalsettings.costcenterData[0].values.length;
