...
export class SystemUsersComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.itemsObservables.subscribe((res: any) => {
      this.data = res.systemusers.systemusersList;
      this.showNumberOfItemsList= res.systemusers.showRowsList;
      this.sortedCols = res.systemusers.sortedCols;
      this.numberOfItems = res.systemusers.systemusersList.length;
